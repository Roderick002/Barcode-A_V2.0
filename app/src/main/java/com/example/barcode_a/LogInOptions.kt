 ...
 * Use the [LogInOptions.newInstance] factory method to
...
class LogInOptions : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_log_in_options, container, false)
    ...
    companion object {
         ...
         * @return A new instance of fragment LogInOptions.
         */
